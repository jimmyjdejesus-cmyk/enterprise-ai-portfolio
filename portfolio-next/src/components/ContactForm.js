...
export default function ContactForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setStatus('TRANSMITTING_PACKET...');
    setTimeout(() => {
      setStatus(`UPLINK_ESTABLISHED: Message from ${name} received.`);
      setName('');
      setEmail('');
      setMessage('');
    }, 600);
        ...
        <div className={styles.contactLayout}>
          <div className={styles.contactInfo}>
            <p className={styles.infoLead}>
              Available for full-time AI/ML engineering, Lead Data Science initiatives, strategic Business Analytics, or consulting.
            </p>
            ...
            <div className={styles.contactMethod}>
              ...
              <div>
                <div className={styles.contactLabel}>DIRECT_EMAIL</div>
            ...
            <div className={styles.sysStatus}>
              ...
              <span>PGP_ENCRYPTION_READY // RESPONSE_TIME &lt; 24H</span>
            </div>
          </div>
